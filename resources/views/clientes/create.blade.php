...
@section('content_header')
    <div class="d-flex justify-content-between">
        <h1 class="text-olive">Crear cliente</h1>
...
@section('content')
    <section></section>
    <form action="{{route('clientes.store')}}" method="POST" id="crear-comercial" novalidate>
        @csrf
        <div class="row">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <select name="tipo" class="form-control form-select " id="tipo" required>
                                        ...
                                        <option value="Empresa" @if(old('tipo')=='Empresa') selected @endif>Empresa
                                        </option>
                                        <option value="Particular" @if(old('tipo')=='Particular')selected @endif>
                                            Particular
                                        </option>
                                    </select>
                                    @error('tipo')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="dni_cif" class="form-control " id="dni_cif"
                                           placeholder="Documento de identificación" value="{{old('dni_cif')}}"
                                           required>
                                    @error('dni_cif')
                                    <div class="text-danger ">
                                        <p class="small m-0">*{{$message}}</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="representante" class="form-control " id="representante"
                                           placeholder="Representante legal" value="{{old('representante')}}">
                                    @error('representante')
                                    <div class="text-danger ">
                                        <p class="small m-0">*{{$message}}</p>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-md-6 ">
                                        ...
                                        <input type="text" name="poblacion" class="form-control " id="ciudad"
                                               placeholder="Ciudad" value="{{old('poblacion')}}">
                                        @error('poblacion')
                                        <div class="text-danger ">
                                            <p class="small m-0">*{{$message}}</p>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 ">
                                        ...
                                        <input type="text" name="cp" class="form-control " id="cp"
                                               placeholder="Codigo postal" value="{{old('cp')}}">
                                        @error('cp')
                                        <div class="text-danger">
                                            <p class="small m-0">*{{$message}}</p>
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-md-4 ">
                                        ...
                                        <input type="tel" name="movil" class="form-control " id="movil"
                                               placeholder="Móvil" onblur="actualizarTelefono()" value="{{old('movil')}}">
                                        @error('movil')
                                        <div class="text-danger ">
                                            <p class="small m-0">*{{$message}}</p>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-4 ">
                                        ...
                                        <input type="tel" name="telefono1" class="form-control " id="telefono_1"
                                               placeholder="Teléfono 1" value="{{old('telefono1')}}">
                                        @error('telefono1')
                                        <div class="text-danger ">
                                            <p class="small m-0">*{{$message}}</p>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-4 ">
                                        ...
                                        <input type="tel" name="telefono2" class="form-control " id="telefono2"
                                               placeholder="Teléfono 2" value="{{old('telefono2')}}">
                                        @error('telefono2')
                                        <div class="text-danger ">
                                            <p class="small m-0">*{{$message}}</p>
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-md-6 ">
                                        ...
                                        <input type="text" name="contacto" class="form-control " id="contacto"
                                               placeholder="Contacto" value="{{old('contacto')}}">
                                        @error('contacto')
                                        <div class="text-danger ">
                                            <p class="small m-0">*{{$message}}</p>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="tel" name="tel_contacto" class="form-control" id="tel_contacto"
                                               placeholder="Teléfono contacto" value="{{old('tel_contacto')}}">
                                        @error('tel_contacto')
                                        <div class="text-danger ">
                                            <p class="small m-0">*{{$message}}</p>
                                        </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="iban" class="form-control" id="iban"
                                       placeholder="IBAN" value="{{old('iban')}}">
                                @error('iban')
                                <div class="text-danger ">
                                    <p class="small m-0">*{{$message}}</p>
                                </div>
                            ...
                            <div class="box-body">
                                <div class="form-group row">
                                    <div class="col-12 col-md-6 ">
                                        ...
                                        <textarea name="notas" id="notas" class="form-control" cols="30" rows="5">{{old('notas')}}</textarea>
                                        @error('notas')
                                        <div class="text-danger ">
                                            <p class="small m-0">*{{$message}}</p>
                                        </div>
